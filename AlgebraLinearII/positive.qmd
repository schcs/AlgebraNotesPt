...
Se $p$ não é invertível, considere a restrição ao complemento ortogonal do núcleo de $p$, onde $p$ é invertível, e defina $u$ como acima nesse subespaço, estendendo $u$ por zero no núcleo. Assim, $u$ é unitário no suporte de $p$ e $f = u p$.
