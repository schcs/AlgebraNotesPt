...
Deixamos para o leitor verificar que estas duas maneiras de calcular $\mbox{pcar}_f(f)$ dão o mesmo resultado. Mas comparar estas 
duas formas de fazer a substituição dá 
$\det X  =\mbox{pcar}_f(f)$. Pondo $b=(b_1,\ldots,b_n)^t$ (vetor coluna), temos que $Xb=0$. Por outro lado, por 
@eq-endo-assoc e por @thm-cramer,
$$
0=\mbox{adj}(X)(Xb)=(\mbox{adj}(X)X)b=(\det X)I_nb=(\det X)b=\mbox{pcar}_f(f)b.
$$
