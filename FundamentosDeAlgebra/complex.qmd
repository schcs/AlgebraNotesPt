...
Um <b>número complexo</b> é uma expressão na forma $a+bi$ onde $a,b\in \R$ e $i$ é uma quantidade  com a propriedade que
$$
i^2=-1.
$$
...
$$
Os números complexos podem ser visualizados em um plano chamado de <b>plano complexo</b>. Cada número complexo pode ser visto como um vetor neste plano e a soma entre números complexos corresponde à soma de vetores.

Se $z=a+bi\in\C$, então $a\in\R$ é dita <b>parte real</b> e $b\in\R$ é chamado de <b>parte imaginária</b> de $z$. Escrevemos que
$$
...
Para um número complexo, $z=a+bi$, definimos $\bar z=a-bi$. O número $\bar z$ é dito <b>conjugado complexo</b>. Pode-se também definir a <b>norma</b>, <b>comprimento</b>, ou <b>módulo</b> de um número complexo $z=a+bi\in\C$:
$$
|z|=\sqrt{a^2+b^2}.
$$
...
Um número complexo $z\in\C$ é dita <b>$k$-ésima raiz da unidade</b> se $z^k=1$.
