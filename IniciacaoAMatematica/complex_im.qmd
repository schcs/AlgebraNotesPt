...
Sobre a história dos números complexos, recomendamos assistir os seguintes vídeos

<iframe width="560" height="315" src="https://www.youtube.com/embed/rApYX4n8ut4?si=iwhgDP4tw23DaO7s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/yfJvsqLTwAI?si=1nOOkqKqulfbT7n0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
:::{#exm-}
Vamos resolver a seguinte equação no conjunto dos números complexos:
$$
x^6-2x^3+2=0. 
$$
Primeiro, fazemos a substituição $y=x^3$ e obtemos a equação quadrática
$$
y^2-2y+2=0.
$$
Usando a fórmula de Bhaskara, encontramos as soluções
$$
y=1\pm i.
$$
Agora, precisamos encontrar as raízes cúbicas de $1+i$ e $1-i$. Note que
\begin{align*}
1+i&=\sqrt{2}\left(\cos{\frac{\pi}{4}}+i\operatorname{sen}{\frac{\pi}{4}}\right);\\
1-i&=\sqrt{2}\left(\cos{\frac{7\pi}{4}}+i\operatorname{sen}{\frac{7\pi}{4}}\right).
\end{align*}
As raízes cúbicas de $1+i$ são
\begin{align*}
z_j&=\sqrt[6]{2}\left(\cos{\frac{\pi+8j\pi}{12}}+i\operatorname{sen}{\frac{\pi+8j\pi}{12}}\right)\\
&=\sqrt[6]{2}\left(\cos{\frac{(1+8j)\pi}{12}}+i\operatorname{sen}{\frac{(1+8j)\pi}{12}}\right)
\end{align*}
com $j=0,1,2$. As raízes cúbicas de $1-i$ são
\begin{align*}
w_j&=\sqrt[6]{2}\left(\cos{\frac{7\pi+8j\pi}{12}}+i\operatorname{sen}{\frac{7\pi+8    j\pi}{12}}\right)\\
&=\sqrt[6]{2}\left(\cos{\frac{(7+8j)\pi}{12}}+i\operatorname{sen}{\frac{(7+8j)\pi}{12}}\right)
\end{align*}
com $j=0,1,2$. Portanto, as seis soluções da equação original são $z_0,z_1,z_2,w_0,w_1,w_2$.
:::

## O Teorema fundamental da Álgebra

Os números complexos foram introduzidos para resolver equações polinomiais que não possuem soluções reais. De fato, o [Teorema Fundamental da Álgebra](https://pt.wikipedia.org/wiki/Teorema_fundamental_da_%C3%A1lgebra) afirma que todo polinômio não constante com coeficientes complexos possui pelo menos uma raiz complexa.

:::{#thm-fundamental-algebra}
Seja $p(z)=a_nz^n+a_{n-1}z^{n-1}+\cdots+a_1z+a_0$ um polinômio com coeficientes em $\C$ 
(ou em $\R$) com $n\geq 1$ e $a_n\neq 0$. Então existe $z_0\in\C$ tal que $p(z_0)=0$.
:::

A demonstração do Teorema Fundamental da Álgebra está fora do escopo desta disciplina e será 
provada na disciplina Variável Complexa.  
