...
Como nós já discutimos, dizemos que $a$ divide $b$ ($a$ e $b$ são números inteiros) se $b=ka$ com algum $k$ inteiro. Neste caso pode-se dizer também que $a$ é um divisor de $b$ ou que $b$ é múltiplo de $a$. Se $a$ divide $b$, então escrevemos $a\mid b$. 
...
**Reflexividade:** Se $a\in\Z$, então $n\mid a-a=0=3\cdot 0$. Logo $a\equiv_3 a$.
...
$$
[0]=\{a\in\Z\mid 0\equiv_3 a\}=\{a\in\Z\mid a-0=3k\}=\{a\in\Z\mid a=3k\}.
$$
Ou seja, 
$$
