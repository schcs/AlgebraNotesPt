...
As relações de equivalência são normalmente denotados com os símbolos $\equiv$, $\cong$, etc, e escrevemos $a\equiv b$ ou $a\cong g$ em vez de $aRb$. 
:::
...
Afirmamos que $[a]=[b]$. Provaremos isso verificando que $[a]\subseteq [b]$ e $[b]\subseteq [a]$. Assuma primeiro que $x\in[a]$. Então 
$$
...
:::{#def-partition}
Seja $A$ um conjunto. Um conjunto $\mathcal P$ de subconjuntos de $A$ é dita *partição* de $A$ se 
...
1. Reflexividade: se $a\in A$, então $a$ e $a$ claramente pertencem à mesma parte de $\mathcal P$ e $a\equiv_{\mathcal P} a$. Logo $\equiv_{\mathcal P}$ é reflexiva. 
