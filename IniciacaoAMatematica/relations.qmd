...
que $a\equiv b$ e a simetria implica que $b\equiv a$. Ora, $b\equiv a$ e $a\equiv x$ e a transitividade implica que 
...
:::{#exr-ztimesz}
Seja $A=\Z\times \Z\setminus\{0\}$ e defina a seguinte relação sobre $A$:
$$
...
3. Dê uma descrição de todas as classes de equivalência.
4. Mostre que $(a,b)\equiv (c,d)$ se e somente se as frações $a/b$ e $c/d$ representam o mesmo número racional.
:::
