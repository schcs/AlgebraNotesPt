...
:::{#exm-relation2}
No @exm-relation, temos que $1$ está relacionado com $2$ pela relação $R$ e escrevemos que $1R2$. Por outro lado, $2$ não está relacionado com $3$ pela mesma relação e escrevemos que $2\not R3$.   
:::
...
3. Dizemos que $R$ é *antisimétrica* se $aRb$ e $bRa$ implicm que $a=b$ para todo $a,b\in A$. 
4. Dizemos que $R$ é *transitiva* se $aRb$ e $bRc$ implicam que $aRc$ para todo $a,b,c\in A$. 
:::

:::{#exm-rel-props}
Considerando as relações no @exm-relations3, temos que as relações de igualdade, maior ou igual, menor ou igual, e divisor são reflexivas. A igualdade e divisor são simétricas. As relações maior ou igual e menor ou igual são antisimétricas, e todas as relações neste exemplo são reflexivas. Por outro lado, a relação no @exm-relation não é reflexiva, pois $1R2$ e $2R1$, mas $1\not R1$. 
:::
...
$$
(a_1,a_2,\ldots,a_k)=(b_1,\ldots,b_k)\quad\mbox{se e somente se}\quad \forall i\in\{1,\ldots,k\}\colon a_i=b_i.
$$
