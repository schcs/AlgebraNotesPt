...
- conceito de polinômio sobre um corpo;
- grau de um polinômio;
- polinômio mônico;
- divisibilidade entre polinômios;
- o MDC de dois polinômios;
- polinômios coprimos (primos entre si);
- o Algoritmo de Euclides para polinômios;
- Polinômios irredutíveis;
- a caraterização de polinômios irredutíveis sobre $\mathbb C$ e $\mathbb R$;
- O critério de Eisenstein para irredutibilidade de um polinômio sobre $\mathbb Q$.
