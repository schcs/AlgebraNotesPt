...
$$
Notando que $x_1=\alpha_1/\alpha\in\E$, obtemos que 
$$
...
:::{#def-sep-ext}
Seja $\E:\F$ uma extensão algébrica. Um elemento $\alpha\in\E$ é dita *separável*, se $m_\alpha(x)$ não possui raízes múltiplas em nenhuma extensão de $\F$. A extensão $\E:\F$ é *separável* se todo elemento $\alpha\in\E$ é separável.
:::
