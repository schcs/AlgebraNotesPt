...
:::{#exr-}
Seja $\E$ um corpo e sejam $\varphi_1,\ldots,\varphi_k\in\aut\E$. Assuma que $\alpha_1,\ldots,\alpha_k\in\E$ tais que $\alpha_1\varphi_1+\cdots+\alpha_k\varphi_k=0$. Mostre que $\alpha_1=\cdots=\alpha_k=0$. Em outras palavras, $\varphi_1,\ldots,\varphi_k$ são linearmente independentes em 
$$
...
são linearmente dependentes em $\mbox{Func}(B,\E)$ e eles são também linearmente dependentes em $\mbox{Hom}_\F(\E,\E)$. são elementos distintos de $\gal\E\F$. Vamos obter uma contradição. Seja $e_1,\ldots,e_n$ uma base de $\E$ sobre $\F$. Considere o sistema de equações lineares sobre $\E$:
\begin{eqnarray*}
