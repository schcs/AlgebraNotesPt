...
:::{.proof}
*Proof.* A definição da base implica que todo elemento de $V$ pode ser
...
:::{.proof}
*Proof.* O espaço vetorial $\{\ul{0}\}$ possui a base $\varnothing$,
...
:::{.proof}
*Proof.* Seja $X$ um conjunto finito de geradores de $V$. Pelo teorema,
...
:::{.proof}
*Proof.* Seja $Y = \{\ul{v_1}, \ldots,\ul{v_{n+1}}\}$ um subconjunto de
...
:::{.proof}
*Proof.* Já que $B$ é uma base de $V$ e $C$ é LI, segue da proposição
...
*Exercício*: Seja $V$ um espaço vetorial de dimensão finita. Já
...
:::{.proof}
*Proof.* Seja $I = \{\ul{v_1}\,,\,\ldots\,,\,\ul{v_a}\}$ uma base de
...
:::{.proof}
*Proof.* Imediato do teorema, pois
...
:::{.proof}
*Proof.* Seja $\{\ul{w_1}\,,\,\ldots,\ul{w_a}\}$ uma base de $W$ e
