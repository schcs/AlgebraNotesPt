...
\end{aligned} 
$$
que satisfaz as propriedades LIN1, e LIN2, LIN1' e
...
$$\begin{aligned}
  ...
  & = {[\ul{u}]_B}^tA([\ul{v}]_B+[\ul{w}]_B)\qquad (v\mapsto [v]_B \mbox{ é linear)}\\
...
\end{aligned} 
$$
[Exercício]{.underline}: Confirme que a função é linear
