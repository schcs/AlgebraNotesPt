...
${\textrm{dim}}({\textrm{Col}}(A) ) = {\textrm{dim}}({\textrm{Lin}}(A)) = 2$, portanto
${\textrm{Rk}}(A) = 2$.
:::
...
resolvendo os sistemas, obtemos $$[T]^{B}_{B'} =
    ...
    0& 6 \\
    0 & -4
\end{pmatrix}.$$ Note que ${\textrm{dim}}({\textrm{Col}}([T]^{B}_{B'})) = 2$, logo
${\textrm{Rk}}([T]^{B}_{B'}) = 2$.
...
${\textrm{Im}}(T)$, logo
$\textrm{dim}({\textrm{Im}}(T)) = 2 = {\textrm{Rk}}([T]^{B}_{B'})$.
:::
...
$${\textrm{dim}}({\textrm{Im}}(T)) = {\textrm{Rk}}([T]^{B}_{C}).$$
:::
