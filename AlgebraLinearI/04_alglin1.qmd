...
linear $\rho:V\to W$ bijetiva. Quando existir um isomorfismo de $V$ a
...
-   Dadas matrizes $A,B$, dizer que $\rho(A+B) = \rho(A) + \rho(B)$ é
    ...
    \end{aligned}$$ [Exercício]{.underline}: Mostre que
...
De fato, a matriz da composição de TLs é sempre o produto das matrizes
...
:::{#thm-}
A matriz $n\times l$ da composição $T_B\circ T_A$ é a matriz produto
